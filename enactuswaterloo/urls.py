...
urlpatterns = patterns('',
    ...
    url(r'^apply/$', RedirectView.as_view(url="https://enactuswaterloo.typeform.com/to/aR8ngC")),
    ...
    url(r'^marketingvpinterview/$', RedirectView.as_view(url="https://plus.google.com/hangouts/_/gzx36h4puv4ibbvihcjo6rq75ya")),
    url(r'^graphicinterview/$', RedirectView.as_view(url="https://plus.google.com/hangouts/_/g4wqvu2vybndq4dnuqqsedzo6ea")),
    url(r'^eventinterview/$', RedirectView.as_view(url="https://plus.google.com/hangouts/_/gvz5nbllnbdaoq7svcjuuk62d4a")),
    url(r'^hrinterview/$', RedirectView.as_view(url="https://plus.google.com/hangouts/_/g3jeboljhk4ey72b3sbj3heu2ya")),
    url(r'^photointerview/$', RedirectView.as_view(url="https://plus.google.com/hangouts/_/gyyz4n2zjbqdxw7k4huvqtoszia")),
